...
class NamesKurdish {
  ...
  factory NamesKurdish.fromMap(Map<String, dynamic> map) {
    return NamesKurdish(
  ...
  factory NamesKurdish.fromJson(String source) =>
      NamesKurdish.fromMap(json.decode(source));
